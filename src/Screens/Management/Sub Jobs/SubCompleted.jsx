import { StyleSheet, Text, View, TextInput, TouchableOpacity, ActivityIndicator, ScrollView, Modal, TouchableWithoutFeedback, Pressable } from 'react-native'
                  ...
                  <View key={i} style={jobsstyles.Tablebox}>
                    <View style={jobsstyles.TableHead}>
                      ...
                      <Pressable
                        ...
                        onPress={() => navigation.navigate('SubJobForm', { id: obj.id, name: 'SubCompleted', action: false })}
                      >
